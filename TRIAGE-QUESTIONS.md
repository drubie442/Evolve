...
## Question 1 — Who is the support for? _(Age)_
...
## Question 4 — Do you need a free service? _(Optional)_
...
These 3 core questions handle ~90% of the filtering work given the data model. Additional refinements (e.g. Aboriginal identity, referral pathway, wait time preference) should be presented _after_ an initial shortlist is shown, rather than asked upfront.
